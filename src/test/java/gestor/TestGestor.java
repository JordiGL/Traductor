...
public class TestGestor {
    ...
    private final Usuari[] usuaris = {
        new Usuari(3, "Gomez", "JoGomLoz@gmail.com", true, "MALE", "Jordi", "$2a$10$RmdEsvEfhI7Rcm9f/uZXPebZVCcPC7ZXZwV51efAvMAp1rIaRAfPK",600000003, "Jordi_admin")
    };
...
//    }
    ...
    public void provaObtenir() throws SQLException, GestorException {
        ...
        Usuari a=gestor.obtenirUsuari("JoGomLoz@gmail.com");

        assertTrue(comparaUsuaris(a,usuaris[0]));
        
//        a=gestor.obtenirUsuari("mariaprova@gmail.com");
